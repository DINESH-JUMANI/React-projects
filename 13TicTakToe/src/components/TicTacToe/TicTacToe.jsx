...
function TicTacToe() {
    ...
    const won = (winner) => {
        setLock(true);
        if (winner === 'x') titleRef.current.innerHTML = `Congratulations <img src = '${circle_icon}'> Wins`;
        else titleRef.current.innerHTML = `Congratulations <img src = '${cross_icon}'> Wins`;
    };
